...
import { Badge, Check, ExternalLink, Medal, User, X } from "lucide-react";
import React, { useEffect, useState } from "react";
import { BarLoader } from "react-spinners";

// doctors : data passing as a prop by admin to get the doctors
const PendingDoctors = ({ doctors }) => {
  // to keep track of currently selected doctors
