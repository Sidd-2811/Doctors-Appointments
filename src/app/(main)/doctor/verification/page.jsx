      ...
      <div className="max-w-2xl mx-auto">
        <Card className="border-emerald-900/30">
          <CardHeader className="text-center">
            ...
            {/* check if user is rejected or not */}
                {
          ...
          <CardContent>
            {
                isRejected ? 
                (<div className='bg-red-900/10 border-red-900/20 rounded-lg p-4 mb-6 flex items-center'>
            ...
            <p className='text-muted-foreground mb-6'>
                {isRejected ? "You can update your doctor profile and resubmit for verification."
